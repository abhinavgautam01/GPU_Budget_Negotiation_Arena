...
def main() -> None:
    ...
    run([sys.executable, "scripts/plot_eval.py", "--input", "artifacts/baseline_eval.json", "--training-input", "artifacts/training_curve.json", "--output", "plots/baseline_rewards.png"])
